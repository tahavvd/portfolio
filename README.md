...
Open the project folder in a browser, or run a local static server:
...
This repository intentionally excludes the private reference files used during development.
